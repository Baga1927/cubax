(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".fit__slider")) new core(".swiper", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            _createClass(Masked, [ {
                ...
                value: function splice(start, deleteCount, inserted, removeDirection) {
                    ...
                    if (removeDirection !== DIRECTION.NONE) {
                        startChangePos = this.nearestInputPos(start, deleteCount > 1 && 0 !== start && !this.eager ? DIRECTION.NONE : removeDirection);
        ...
        var MaskedNumber = function(_Masked) {
            ...
            _createClass(MaskedNumber, [ {
                ...
                value: function doPrepare(ch) {
                    ...
                    var _normalizePrepare = normalizePrepare(_get(_getPrototypeOf(MaskedNumber.prototype), "doPrepare", this).call(this, ch, flags)), _normalizePrepare2 = _slicedToArray(_normalizePrepare, 2), prepCh = _normalizePrepare2[0], details = _normalizePrepare2[1];
